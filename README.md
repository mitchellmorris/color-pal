...
This project was completed as part of a take-home coding challenge. Through this implementation, I aimed to demonstrate not only technical proficiency, but also deliberate architectural choices and thoughtful attention to user experience.
